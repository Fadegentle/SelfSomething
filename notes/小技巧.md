<!-- no toc -->
- [装机软件](#装机软件)
- [浏览器](#浏览器)（ [推荐软件](#推荐软件) & [推荐插件](#推荐插件) ）
- [系统硬件](#系统硬件)（ [信息查看](#信息查看) & [Windows](#windows-1) - [Win 键](#win-键) - [Powershell](#powershell) - [CMD](#cmd) & [Linux](#linux) & [MacOS](#macos-1) & [推荐软件](#推荐软件-1) ）
- [环境变量](#环境变量)（ [Windows](#windows-2) - [Powershell](#powershell-1) - [CMD](#cmd-1) & [Linux/Unix](#linuxunix) & [MacOS](#macos-2) ）
- [进程管理](#进程管理)（ [Windows](#windows-3) & [Linux/Unix](#linuxunix-1) & [MacOS](#macos-3) & [推荐软件](#推荐软件-2) ）
- [用户和组](#用户和组)（ [Windows](#windows-4) - [CMD](#cmd-2) & [Linux/Unix](#linuxunix-2) ）
- [文本文件](#文本文件)（ [Windows](#windows-5) - [Powershell](#powershell-2) - [CMD](#cmd-3) & [Linux/Unix](#linuxunix-3) & [推荐软件](#推荐软件-3) ）
- [网络传输](#网络传输)（ [Windows](#windows-6) - [Powershell](#powershell-3) - [CMD](#cmd-4) - [MacOS](#macos-4) & [代理](#代理) & [Clash](#clash) & [推荐软件](#推荐软件-4) ）
- [终端](#终端)（ [Windows Terminal](#windows-terminal) & [Powershell](#powershell-4) & [CMD](#cmd-5) & [bash/sh/zsh](#bashshzsh) & [推荐软件](#推荐软件-5) ）
- [编译](#编译)（ [推荐软件](#推荐软件-6) ）
- [Git](#git)（ [GitHub](#github) & [推荐插件](#推荐插件-1) ）
- [Docker](#docker)
- [IDE/Editor](#ideeditor)（ [VSCode](#vscode) - [推荐插件](#推荐插件-2) & [JetBrain](#jetbrain) - [推荐插件](#推荐插件-3) & [vi/vim](#vivim) & [推荐软件](#推荐软件-7) ）
- [游戏](#游戏)（ [Steam](#steam) & [Epic](#epic) & [Xbox/MS Store](#xboxms-store) ）
- [AI](#ai)（ [Anaconda](#anaconda) & [CUDA](#cuda) & [Pytorch](#pytorch) & [HuggingFace](#huggingface) & [Lmdeploy](#lmdeploy) & [推荐软件](#推荐软件-8) ）
...
### Win 键
- `l`（ 锁屏 ）、`e`（ 资源管理器 ）、`d`（ 桌面 ）、`v`（ 剪切板 ）、`tab`（ 桌面切换 ）、`x`（ `Win` 右键菜单 ）
- `r`（ 运行 ）
...
- 帧率可以在显卡中限制，英伟达卡控制面板 `管理 3D 设置`，设置 `最大帧数率` 为 `180`（屏幕刷新率加点盈余），`后台应用程序最大帧速率` 为 `24/30`（如果有习惯同时干几件事可以设置到自己的容忍下限 `60/120`）
