...
## 1）仅内网串流
1. 电脑安装 [Sunshine 基地版](https://github.com/qiin2333/Sunshine-Foundation)（[配置注意事项](#sunshine-基地版)）、[Moonlight 配置工具](https://github.com/moonlight-stream/Internet-Hosting-Tool/releases)
...
## 3）远程开机+公网串流
1. 使用 `WoL` 或者 `智能插座`，控制远程开机
2. 同 [2）公网串流](#2公网串流)

> [!IMPORTANT] 一定要保持电脑电源通电！！！
---
# 附录：相关学习
## 内网穿透
